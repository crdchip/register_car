...
class FormRegisterInCustomerScreen extends StatefulWidget {
  const FormRegisterInCustomerScreen({
    super.key,
  });

  @override
  State<FormRegisterInCustomerScreen> createState() =>
      _FormRegisterInCustomerScreenState();
}

class _FormRegisterInCustomerScreenState
    extends State<FormRegisterInCustomerScreen> {
  final String routes = "/form_register_in_customer_screen";
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            TextForm(
              title: "Tài xế",
              controller: _customerController.nameDriver,
            ...
            TextForm(
              title: "Biển số xe",
              controller: _customerController.numberCar,
            ...
            isCheckProduct
                ? TextForm(
                    title: "Số công 1",
                    controller: _customerController.contNumber1,
                    icon: Icons.abc,
                    hintText: '')
                : Container(),
            //Số seal
            isCheckProduct
                ? TextForm(
                    title: "Số seal 1",
                    controller: _customerController.cont1seal1,
                    icon: Icons.abc,
                    hintText: '')
                : Container(),
            isCheckProduct
                ? TextForm(
                    title: "Số seal 2",
                    controller: _customerController.cont1seal2,
                    icon: Icons.abc,
                    hintText: '')
                : Container(),
            isCheckProduct
                ? TextForm(
                    title: "Số seal 3",
                    controller: _customerController.cont1seal3,
                    icon: Icons.abc,
                    hintText: '')
                : Container(),
  ...
  postRegis() {
    return _customerController.postRegisterCar(
      ...
      // "", "", "", "",
      _customerController.contNumber1.text,
      _customerController.cont1seal1.text,
      _customerController.cont1seal2.text,
      _customerController.cont1seal3.text,
      "",
      "",
      "",
      "",
