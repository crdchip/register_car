...
class HistoryDeatailSercurityScreen extends StatefulWidget {
  const HistoryDeatailSercurityScreen({
    super.key,
    this.dataform,
    this.tracking0,
    this.linesId,
  ...
  @override
  State<HistoryDeatailSercurityScreen> createState() =>
      _HistoryDeatailSercurityScreenState();
}

class _HistoryDeatailSercurityScreenState
    extends State<HistoryDeatailSercurityScreen> {
  final String routes = "/history_sercurity_screen";

  final _historyController = HistoryTracking1Controller();
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<HistoryTracking1Controller>(
        ...
        builder: (context) => Scaffold(
            appBar: AppBar(
              title: Text(
                  "Details Page ${widget.linesId} + ${widget.tracking0!.id}"),
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    buttonForm(size, () {
                      _historyController.putTrackinglv2(
                          widget.linesId, widget.tracking0!.id);
                    })
                  ],
                ),
              ),
