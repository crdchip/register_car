...
class AdminTallyManDetailsScreen extends StatefulWidget {
  const AdminTallyManDetailsScreen({super.key});

  @override
  State<AdminTallyManDetailsScreen> createState() =>
      _AdminTallyManDetailsScreenState();
}

class _AdminTallyManDetailsScreenState
    extends State<AdminTallyManDetailsScreen> {
  final String routes = "/admin_tallyman_details_screen";
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: TextButton(
                              onPressed: () {
                                controller.putTrackinglv3(items.id);
                              },
                              style: ButtonStyle(
                                backgroundColor:
