...
class AdminSercurityFinalDetailsScreen extends StatefulWidget {
  const AdminSercurityFinalDetailsScreen({super.key});

  @override
  State<AdminSercurityFinalDetailsScreen> createState() =>
      _AdminSercurityFinalDetailsScreenState();
}

class _AdminSercurityFinalDetailsScreenState
    extends State<AdminSercurityFinalDetailsScreen> {
  var items = Get.arguments as Tracking;
  final String routes = "/admin_sercurity_final_details_screen";
  @override
