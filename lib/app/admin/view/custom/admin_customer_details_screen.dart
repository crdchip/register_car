...
class AdminCustomerDetalsScreen extends StatefulWidget {
  const AdminCustomerDetalsScreen({super.key});

  @override
  State<AdminCustomerDetalsScreen> createState() =>
      _AdminCustomerDetalsScreenState();
}

class _AdminCustomerDetalsScreenState extends State<AdminCustomerDetalsScreen> {
  final String routes = "/admin_customer_details_screen";
